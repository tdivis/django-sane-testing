...
### From here on, everything's auto-generated from XML
    ...
    def captureNetworkTraffic(self, data_type):
        """
        ...
        'data_type' is The type of data to return the network traffic as. Valid values are: json, xml, or plain.
        """
        return self.get_string("captureNetworkTraffic", [data_type, ])
